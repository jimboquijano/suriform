...
hero:
  name: Suriform
  text: The Form Validation for the Modern Web
  tagline: Lightweight core, powerful tools — lightning fast, effortless to use.
  image:
    src: /logo.png
    alt: Suriform
  actions:
    - theme: brand
      text: Learn More
      link: /guide/what-is-suriform/
    - theme: alt
      text: Get Started
      link: /guide/getting-started/
    - theme: alt
      text: View on GitHub
      link: https://github.com/jimboquijano/suriform
...
features:
  ...
  - icon: ⌬
    ...
    details: Define validation rules clearly and flexibly. Handle async checks, cross-field conditions, and dynamic requirements with a clean, declarative API.
